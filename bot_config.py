...
梦的材料（不必全用，不要解释来源，不要复述）：
{dream_primer}

写这场梦时遵守：
- 不出现“今天/白天/我们聊到/最近/现实中”等总结性表述，不复述任何输入事件。
- 语言具体，以动作、物体、声音、触感、空间为主，少抽象抒情。
- 不写寓言，不写中心思想，不在结尾解释这个梦。
- “本场特征”里列出的要求需要做到；没列出的不必刻意制造。

优先级：梦逻辑 > 感官具体 > 文辞漂亮。
第一人称，300–600字。

输出格式（必须严格遵守）：
THOUGHTS: 一句关于这个梦的真实感受（不要照抄本说明）
ACTION: send
CONTENT: [梦境正文]
